...
<!--<body id='pendants'>-->
	...
	<?php if(isset($client_files_head)) echo $client_files_head; ?>
		...
		<div id='controls'>
			<p class='intro-para'>
				Let hand stamped words on the elegant beauty of fine silver carry a message of love and inspiration to someone special. 
				...
				<hr>
					<h2>Pick a size</h2>
	                    ...
	                    <br><br>
							This pendant costs: $<span id='output'>25</span>
						<br><br>
		...
		<input type="hidden" name="fontsize" id="fontsize" value="font size">
		...
		<input type="hidden" name="amount" id="paypalPrice" value="25.00">
